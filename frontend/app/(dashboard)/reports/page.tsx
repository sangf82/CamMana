...
export default function ReportsPage() {
  ...
  useEffect(() => {
    // Small delay to ensure DOM is ready and container sizes are calculated
  ...
  return (
    <div className="h-full flex flex-col overflow-hidden bg-background">
      <div className="max-w-[1500px] w-full mx-auto flex-1 flex flex-col p-6 gap-4 overflow-y-auto min-h-0">
        {/* Header */}
          ...
          <Card>
            ...
            <CardContent>
              <div className="flex items-baseline gap-1">
                ...
                <span className="text-sm font-medium text-muted-foreground">xe</span>
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <div className="flex items-baseline gap-1">
                ...
                <span className="text-sm font-medium text-muted-foreground">m³/xe</span>
              </div>
            </CardContent>
          </Card>
        </div>
