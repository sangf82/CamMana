      ...
      >
        <div className="space-y-6">
          ...
          {(editingItem?.id === 0 || !editingItem?.id) && (
            <div className="bg-amber-500/10 border border-amber-500/20 rounded-lg p-4 mb-2">
              <div className="flex items-center justify-between gap-4">
                ...
                <label className="cursor-pointer bg-[#f59e0b] hover:bg-[#f59e0b]/90 text-black px-4 py-2 rounded-md text-xs font-bold transition-all shadow-md active:scale-95 flex items-center gap-2">
          ...
          <div className="space-y-4">
             <div className="flex items-center gap-2 text-[#f59e0b] font-semibold border-b border-border pb-2">
             ...
             <div className="grid grid-cols-2 gap-6">
                ...
                <div className="space-y-2">
                    ...
                    <div className="relative flex items-center bg-background border border-border rounded focus-within:border-[#f59e0b] transition-all w-full">
                        <input 
                            ...
                            placeholder="Số bánh"
                        />
                        <span className="absolute right-3 text-[10px] font-bold text-[#f59e0b] uppercase select-none pointer-events-none">bánh</span>
                    </div>
                </div>
              </div>
              ...
              <div className="space-y-2">
                  ...
                  <div className="flex items-center">
                      <div className="flex-1">
                          <input 
                              ref={minVolRef}
                              className="w-full p-2.5 bg-background border border-border rounded focus:border-[#f59e0b] focus:ring-0 outline-none font-mono text-md text-center"
                              value={vMin}
                      ...
                      <div className="w-6 flex justify-center items-center text-muted-foreground font-bold">
                          -
                      </div>
                      <div className="flex-1">
                          <input 
              ...
              <p className="text-[10px] text-muted-foreground italic mt-1">Sử dụng phím mũi tên để di chuyển giữa 2 ô thể tích</p>
          </div>
          ...
          <div className="pt-4 flex items-center justify-end gap-3 border-t border-border mt-6">
            ...
            >
             ...
             <button 
                type="submit" 
                className="px-6 py-2 rounded bg-[#f59e0b] text-black text-sm font-bold hover:bg-[#f59e0b]/90 transition-all shadow-md active:scale-95"
            >
