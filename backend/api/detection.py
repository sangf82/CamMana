...
@detection_router.get("/captured_cars", response_model=List[CapturedCar])
...
@detection_router.get("/captured_cars/search", response_model=List[CapturedCar])
...
@detection_router.get("/detection_logs", response_model=List[LogRecord])
